...
await writeFile(path.join(root, 'SEO_AUDIT_REPORT.md'), currentReportHeader.replace('## Inputs needed from the owner', finalQualitySummary + '## Inputs needed from the owner') + reportTable, 'utf8');
